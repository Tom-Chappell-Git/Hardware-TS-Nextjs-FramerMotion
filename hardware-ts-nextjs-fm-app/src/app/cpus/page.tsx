...
import iProducts from '../productinfos/intelcpus.json';
...
{isMobile ? <MobileNavbar /> : <Navbar />}
      ...
      >
        ...
        <div className="container mx-auto p-4 py-10">
          <h2 className="text-3xl font-bold mb-6 font-mono">Intel CPUs</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {iProducts.map((product, index) => ( // ProductCard component for each CPU in the iProducts array.
              <motion.div
                key={product.id}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
